...
if __name__ == "__main__":
    ...
    cmd = 'export server_port={};\
           ...
           python3.6 /home/3_write_files.py'.format(server_port, public_ip, telegram_bot_token, telegram_chat_id)
    execute_command(cmd=cmd, ip=node_ip, port=pub_port)
    # start server
    execute_command(cmd='caddy -conf /mnt/data/Caddyfile', ip=node_ip, port=pub_port)
